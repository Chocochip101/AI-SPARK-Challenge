...
# evaluate_summary: 점수를 계산할 함수입니다. 정답(user_summary), 예측(machine_summary)을 인자로 입력받아 score를 반환합니다.
...
# 스코어 산출
score = evaluate_summary(gt, pred) # 위에서 정의한 함수에 불러온 정답 테이블 및 결과 테이블을 입력하여 스코어를 계산합니다.
print(f"score:{score}")
##############################################################################
